...
| Ablauf                       | 1. Der aktive Spieler kann eine oder mehrere Truppen in andere, von ihm besetzte, benachbarte Gebiete verschieben <br>2. Der aktive Spieler kann das Truppenmanövrieren jederzeit beenden. <br>3. Falls der aktive Spieler in diesem Zug mindestens ein Gebiet erobert hat, kann er über die Aktion „Spielkarte anfordern“ eine Gebietskarte beim Spielsystem anfordern, welche ihm bei erfolgreicher Prüfung ausgegeben wird. <br> 4. Der nächste Spieler der Reihenfolge wird aktiviert, der bisherige deaktiivert.|
