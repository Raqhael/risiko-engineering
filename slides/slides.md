...
---
## Truppenmobilisierungsphase
<table>
    <tbody>
      <tr>
          <td>Geschäftsprozess, Funktion</td>
          <td>Truppenmobilisierung durchführen</td>
      </tr>
      <tr>
          <td>Ziel, Ergebnisse</td>
          <td>Der aktive Spieler hat Truppen erhalten und diese anschließend auf seine eroberten Länder mobilisiert.</td>
      </tr>
      <tr>
          <td>Akteure</td>
      ...
      <tr>
          ...
          <td>1. Die Länder im Besitz des aktiven Spielers sind bekannt. <br> 2. Der vorherige Spieler hat seinen Zug vollständig abgeschlossen.</td>
      </tr>
      <tr>
          <td>Auslösendes Ereignis</td>
          <td>Der Wechsel eines Spielers vom passiven zum aktiven Spielerstatus.</td>
      </tr>
      <tr>
          <td>Nachbedingung bei Erfolg</td>
          <td>1. Der aktive Spieler hat T = n/3 Truppen bekommen (n = Anzahl eroberte Länder), wobei <i>T immer ≥ 3 ist.</i> <br> 2. Alle verfügbaren Truppen wurden auf die schon eroberten Länder mobilisiert. <br> 3. Übergang in die Kampfphase.</td>
      </tr>
      <tr>
      ...
      <tr>
          ...
          <td>1. Anzahl der eroberten Länder <br> 2. Anzahl der Spielkarten</td>
      </tr>
      <tr>
          <td>Ausgehende Daten</td>
          <td>Aktualisierte Truppenanzahlen pro Land.</td>
      </tr>
      <tr>
          <td>Ablauf</td>
          <td>
          <span v-mark.box.red="1">
          1. Der aktive Spieler erhält sein berechnetes Truppenkontingent zur Verteilung. <br> 2. Der Spieler hat die Möglichkeit extra Truppen durch Einlösen 3 gleicher oder 3 verschiedener Spielkarten zu erhalten. <br> 3. Der aktive Spieler verteilt seine verfügbaren Truppen auf seine Länder im Besitz.
          </span>
          </td>
      </tr>
      <tr>
          <td>Erweiterungen</td>
          <td>Der aktive Spieler hat die Möglichkeit, drei Spielkarten der gleichen oder jeweils unterschiedlichen Truppengattung für zusätzliche Truppen einzulösen. Die Anzahl der dabei erhaltenen Truppen richtet sich nach der Anzahl vorhergegangener Karteneinlösungen und dem Umstand, inwiefern der Spieler sich im Besitz der auf den Karten abgebildeten Ländern befindet.</td>
      </tr>
      <tr>
          <td>Alternativen</td>
          <td>Durch den Wechsel vom passiven zum aktiven Spieler wird sichergestellt, dass die Truppenmobilisierung immer stattfindet. Der aktive Spieler <b>muss</b> diese Phase zu Ende führen.</td>
      </tr>
    </tbody>
</table>
---
